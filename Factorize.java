...
public class Factorize {
    ...
    public void setNN(BigInteger num){ number = num;}
    public  void setEnd(BigInteger end){stopPoint = end;}
    public BigInteger getEnd(){return stopPoint;}
    public BigInteger getNN(){return number;}
}
...
class MyThread extends Thread {
    ...
    Factorize object = new Factorize();
    MyThread(BigInteger n, BigInteger begn, BigInteger stop, Factorize f) {
        this.start = begn;
        this.end = stop;
        this.nn = n;
        this.object = f;}
